...
test_file="_test_acc_coloring_orbit_result.cxx"
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} ${algebra_src_path}permutation.cxx ${algebra_src_path}symmetry_group_generator.cxx ${basic_src_path}global.cxx ${basic_src_path}math.cxx ${permutator_src_path}next_iter_permutator.cxx ${combinator_src_path}gray_code_combinator.cxx ${topology_src_path}birkhoff_diamond.cxx ${topology_src_path}ring.cxx ${topology_src_path}planar_graph.cxx ${basic_src_path}graph.cxx
