...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} permutation.cxx ${basic_src_path}global.cxx ${basic_src_path}math.cxx ${permutator_src_path}next_iter_permutator.cxx
