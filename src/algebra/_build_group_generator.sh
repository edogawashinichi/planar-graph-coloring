...
permutator_src_path="./permutator/"
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} permutation.cxx symmetry_group_generator.cxx ${basic_src_path}global.cxx ${basic_src_path}math.cxx ${combinatorics_src_path}gray_code_combinator.cxx ${permutator_src_path}next_iter_permutator.cxx
