...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} permutation.cxx symmetry_group_generator.cxx symmetry_group.cxx ${basic_src_path}global.cxx ${basic_src_path}math.cxx ${combinator_src_path}gray_code_combinator.cxx ${permutator_src_path}next_iter_permutator.cxx
