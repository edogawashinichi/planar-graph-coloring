...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} birkhoff_diamond_relation_builder.cxx relation_manager.cxx relation.cxx ${topology_src_path}birkhoff_diamond.cxx ${topology_src_path}ring.cxx ${topology_src_path}graph.cxx ${algebra_src_path}symmetry.cxx ${color_src_path}color_result.cxx ${color_src_path}naive_color_representation.cxx ${color_src_path}birkhoff_diamond_colorer.cxx ${basic_src_path}math.cxx
