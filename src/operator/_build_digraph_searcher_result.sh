...
test_file="_test_digraph_searcher_result.cxx"
parameter=""
if [ $# -ge 1 ]; then
  parameter=$1
fi
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} digraph_searcher_result.cxx directed_path_result.cxx directed_path.cxx path.cxx ${basic_src_path}global.cxx 
