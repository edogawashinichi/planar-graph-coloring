...
test_file="_test_acc_coloring_result.cxx"
parameter=""
if [ $# -ge 1 ]; then
  parameter=$1
fi
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} ${topology_src_path}birkhoff_diamond.cxx ${topology_src_path}ring.cxx ${basic_src_path}graph.cxx ${basic_src_path}math.cxx ${basic_src_path}global.cxx ${topology_src_path}planar_graph.cxx
