...
test_file="_test_naive_color_representation.cxx"
parameter=""
if [ $# -ge 1 ]; then
  parameter=$1
fi
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} ${src_path}naive_color_representation.cxx ${basic_src_path}global.cxx
