...
public:
  ...
  virtual void reasonByVertexColor(const RelationManager& relation_manager, const Interpreter& classification_interpreter, const size_t i, Interpreter* kempe_interpreter) override;
