...
public:
  ...
  virtual void reasonByVertexColor(const RelationManager& relation_manager, const size_t i, Interpreter* kempe_interpreter, Interpreter* classification_interpreter) override;
