...
/// count number of variable parameters of macro, max supporting number 10
...
#define CLASS_CONSTRUCTOR_DEFAULT_VARIABLE(Class, ...) \
inline Class() { \
} /* constructor default */
#define CLASS_CONSTRUCTOR_DEEPCOPY_VARIABLE(Class, rhs, ...) \
inline Class(const Class& rhs) { \
  if (this != &rhs) { \
    ASSIGN(rhs, __VA_ARGS__) \
  } \
} /* constructor deepcopy */
#define CLASS_CONSTRUCTOR_MOVECOPY_VARIABLE(Class, rhs, ...) \
inline Class(Class&& rhs) { \
  if (this != &rhs) { \
    SWAP(rhs, __VA_ARGS__) \
  } \
} /* constructor movecopy */
#define CLASS_ASSIGNMENT_DEEPCOPY_VARIABLE(Class, rhs, ...) \
...
#define CLASS_ASSIGNMENT_MOVECOPY_VARIABLE(Class, rhs, ...) \
...
#define CLASS_5_FUNCTIONS_VARIABLE(Class, ...) \
CLASS_CONSTRUCTOR_DEFAULT_VARIABLE(Class, rhs, __VA_ARGS__) \
CLASS_CONSTRUCTOR_DEEPCOPY_VARIABLE(Class, rhs, __VA_ARGS__) \
CLASS_CONSTRUCTOR_MOVECOPY_VARIABLE(Class, rhs, __VA_ARGS__) \
CLASS_ASSIGNMENT_DEEPCOPY_VARIABLE(Class, rhs, __VA_ARGS__) \
CLASS_ASSIGNMENT_MOVECOPY_VARIABLE(Class, rhs, __VA_ARGS__)
