...
test_file="_test_neighborhood.cxx"
parameter=""
if [ $# -ge 1 ]; then
  parameter=$1
fi
...
g++ -Wall -std=c++17 -o ${obj_file} -cpp ${test_file} planar_graph.cxx ${basic_src_path}graph.cxx ${src_path}ring.cxx ${basic_src_path}global.cxx
